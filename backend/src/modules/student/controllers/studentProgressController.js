<<<<<<< HEAD:backend/src/modules/student/controllers/studentProgressController.js
...
exports.getStudentRankings = async (req, res) => {
    try {
        ...
        const collegeRank = allProgress.findIndex(p => p.userId === studentId) + 1;
        ...
        const branchRank = branchProgress.findIndex(p => p.userId === studentId) + 1;
        ...
        const sectionRank = sectionProgress.findIndex(p => p.userId === studentId) + 1;
...
module.exports = exports;
>>>>>>> 54c65193bef0adb8c05bc7e519e5e1e947a58c34:backend/src/controllers/studentProgressController.js
