<<<<<<< HEAD:backend/src/modules/admin/controllers/adminFacultyController.js
...
exports.createFaculty = async (req, res) => {
    try {
        ...
        // Log activity (fire and forget)
        const { logFacultyAdded } = require('../middleware/activityLogger');
        logFacultyAdded(faculty._id, email, name, department).catch(err => {
            console.error('Failed to log faculty addition:', err);
        });
...
>>>>>>> 54c65193bef0adb8c05bc7e519e5e1e947a58c34:backend/src/controllers/adminFacultyController.js
