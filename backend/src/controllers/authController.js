...
const { findByEmail: findStellaProfile } = require('../modules/faculty/controllers/facultyStellaController');
...
exports.login = async (req, res) => {
    try {
        ...
        if (user.role === 'student') {
            ...
            // Look up MUJ Stella data for faculty
            const stella = findStellaProfile(user.email);
            if (stella) {
                stellaProfile = {
                    photo_url: stella.photo_url,
                    designation: stella.designation,
                    department: stella.department,
                    phone: stella.phone,
                    linkedin: stella.linkedin,
                    detail_url: stella.detail_url
                };
            }
        }
