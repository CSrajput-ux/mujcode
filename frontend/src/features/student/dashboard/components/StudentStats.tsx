<<<<<<< HEAD:frontend/src/features/student/dashboard/components/StudentStats.tsx
...
export default function StudentStats() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                if (!user?.id) {
                    setLoading(true); // Keep loading if user not yet available
                    return;
                }
...
>>>>>>> 54c65193bef0adb8c05bc7e519e5e1e947a58c34:frontend/src/app/components/StudentStats.tsx
