...
const StudentProblems = lazy(() => import('@/features/student/problems/pages/ProblemsPage'));
const StudentAnalytics = lazy(() => import('@/features/student/analytics/pages/AnalyticsPage'));
const StudentTests = lazy(() => import('@/features/student/tests/pages/TestsPage'));
const StudentLearning = lazy(() => import('@/features/student/profile/pages/LearningPage'));
const StudentAssignments = lazy(() => import('@/features/student/assignments/pages/AssignmentsPage'));
const MCQTestList = lazy(() => import('@/features/student/tests/pages/MCQTestList'));
const MCQTestRunner = lazy(() => import('@/features/student/tests/pages/MCQTestRunner'));
const CodingTestRunner = lazy(() => import('@/features/student/tests/pages/CodingTestRunner'));
const TheoryTestRunner = lazy(() => import('@/features/student/tests/pages/TheoryTestRunner'));
...
const CompanyAssessments = lazy(() => import('@/features/company/assessments/pages/AssessmentsPage'));
...
<<<<<<< HEAD
          ...
          <Route path="/student/problems" element={<ProtectedRoute requiredFeature="problems"><StudentProblems /></ProtectedRoute>} />
          {/* Support both problem ID formats */}
          <Route path="/student/problems/:id" element={<ProtectedRoute requiredFeature="problems"><StudentProblemSolver /></ProtectedRoute>} />
          <Route path="/student/problem/:id" element={<ProtectedRoute requiredFeature="problems"><StudentProblemSolver /></ProtectedRoute>} />
